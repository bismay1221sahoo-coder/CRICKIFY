    ...
    <main className="mx-auto grid min-h-[calc(100vh-73px)] max-w-6xl items-center px-4 py-10">
      <section className="mx-auto w-full max-w-md rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
          {mode === "register" && (
            <>
              <input name="name" value={form.name} onChange={updateField} placeholder="Name" className="rounded-md border border-slate-300 px-3 py-2" />
              <input name="phone" value={form.phone} onChange={updateField} placeholder="Phone" className="rounded-md border border-slate-300 px-3 py-2" />
              <input name="city" value={form.city} onChange={updateField} placeholder="City" className="rounded-md border border-slate-300 px-3 py-2" />
            </>
          )}
          <input name="email" type="email" value={form.email} onChange={updateField} placeholder="Email" className="rounded-md border border-slate-300 px-3 py-2" />
          <input name="password" type="password" value={form.password} onChange={updateField} placeholder="Password" className="rounded-md border border-slate-300 px-3 py-2" />
